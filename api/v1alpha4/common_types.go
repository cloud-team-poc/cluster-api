...
const (
	...
	// ExternallyManagedAnnotation is an annotation that can be applied to InfraCluster resources to signify that
	...
	// An external controller must fulfil the contract of the InfraCluster resource.
	// External infrastructure providers should ensure that the annotation, once set, cannot be removed.
	ExternallyManagedAnnotation = "cluster.x-k8s.io/managed-by"
)
